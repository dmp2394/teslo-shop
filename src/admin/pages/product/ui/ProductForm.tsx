...
import { X, SaveAll, Tag, Upload, Plus, Loader } from 'lucide-react';
...
export const ProductForm = ({ title, subTitle, product, onSubmit, isPending = false }: Props) => {
            ...
            <div className="flex justify-between items-center">
                ...
                <div className="flex justify-end mb-10 gap-4">
                    ...
                    <Button type="submit" disabled={isPending}>
                        {isPending ? <Loader className="animate-spin w-12 h-12 text-blue-500" /> : <SaveAll className="w-4 h-4" />}
                        Guardar cambios
                    </Button>
